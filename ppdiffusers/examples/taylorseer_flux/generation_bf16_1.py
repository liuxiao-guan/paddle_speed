...
if __name__ == '__main__':
    ...
    if args.blockdance == True:
        ...
        if args.dataset == "coco10k":
            ...
            saved_path = os.path.join(args.saved_path,"blockdance_R900-100_B30-15_N4_coco1k")
    ...
    if args.teacache == True :
        ...
        pipe.transformer.rel_l1_thresh = (
            0.38  # 0.25 for 1.5x speedup, 0.4 for 1.8x speedup, 0.6 for 2.0x speedup, 0.8 for 2.25x speedup
        )
        ...
        if args.dataset == "coco10k":
            ...
            saved_path = os.path.join(args.saved_path,"teacache0.38_nomid_coco1k")
