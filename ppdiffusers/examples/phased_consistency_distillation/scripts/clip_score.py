...
def evaluate():
    ...
    parser.add_argument("--prompt_type", type=str, default="coco1k")
    args = parser.parse_args()

    all_captions = []
    if args.prompt_type == "drawbench":
        with open(os.path.join("/root/paddlejob/workspace/env_run/gxl/paddle_speed/ppdiffusers/examples/taylorseer_flux/prompts", "DrawBench.txt"), 'r', encoding='utf-8') as f:
