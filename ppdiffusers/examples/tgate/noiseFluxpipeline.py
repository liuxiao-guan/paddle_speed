...
class NoiseFluxPipeline(
    ...
    def __call__(
        ...
        with self.progress_bar(total=num_inference_steps) as progress_bar:
            for i, t in enumerate(timesteps):
                ...
                if i >20 and i < 40:
                    ...
                    pre_noise_pred = noise_pred
                
                all_noise_preds.append(noise_pred.clone())
        ...
        step_l1_losses = []
        for i in range(1, len(all_noise_preds)):
            l1 = Fn.l1_loss(all_noise_preds[i - 1], all_noise_preds[i]).item()
            step_l1_losses.append(l1)
        ...
        plt.plot(range(len(step_l1_losses)), step_l1_losses, label="L1(a_t, a_{t+1})")
        plt.xlabel("Timestep Index")
        plt.ylabel("L1 Loss between Consecutive Predictions")
        plt.title("Noise Prediction Difference Across Timesteps")
        plt.grid(True)
        plt.legend()
        plt.tight_layout()
        plt.show()
        plt.savefig("step_l1_losses.png")
